...
def a( quantidade_de_dias, quantidade_de_horas, quantidade_de_minutos, quantidade_de_segundos):
    y = quantidade_de_dias * 3600 * 24 + quantidade_de_horas * 3600 + quantidade_de_minutos * 60 + quantidade_de_segundos
    return y
print (y( quantidade_de_dias, quantidade_de_horas, quantidade_de_minutos, quantidade_de_segundos))
