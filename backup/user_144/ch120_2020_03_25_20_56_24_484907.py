...
while True:
    ...
    if dinheiro == 0:
        ...
        break
    aposta = int(input("Faça uma aposta para poder jogar o game/ Digite 007 para sair: "))
    ...
    pergunta = input("Deseja apostar em numero ou paridade? Digite'n' para numero e 'p' para paridade: ")
