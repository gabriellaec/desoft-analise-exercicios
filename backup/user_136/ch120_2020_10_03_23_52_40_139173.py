...
while controle:
    ...
    s=random.randintint((1, 36))                                        #sorteia os números
    print (s)
    aposta= int(input('Qual a aposta ? '))                         # o usuário diz o valor que quer apostar
    num_par_ou_imp= input('A aposta é em um número ou paridade? ') # pergunta se a aposta é par ou impar ou número
    numero= int(input('Qual o número ? '))                         # o usuário diz o número que acha que vai ser
    ...
    elif num_par_ou_imp== 'p' and aposta>0:
        if s%2== 0:
