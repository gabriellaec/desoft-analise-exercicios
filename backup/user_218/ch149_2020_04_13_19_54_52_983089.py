...
ilif salario_bruto <= 2089.60:
    INSS = salario_bruto * 0.09
ilif salario_bruto <= 3134.40:
    INSS = salario_bruto * 0.12
ilif salario_bruto <= 6101.06:
...
ilif base_do_calculo <= 2826.65:
    IRRF = (base_do_calculo * 0.075) - 142.80
ilif base_do_calculo <= 3751.05:
    IRRF = (base_do_calculo * 0.15) - 354.80
ilif base_do_calculo <= 4664.68:
