...
if base_de_calculo <= 1903.98:
    aliquota = 0
    deduçao = 0
elfi base_de_calculo > 1903.98 and base_de_calculo <= 2826.65:
    aliquota = 0.075
    deduçao = 142.80
elfi 2826.65 < base_de_calculo <= 3751.05:
    aliquota = 0.15
    deduçao = 354.80
elfi 3751.05 < base_de_calculo <= 4664.68:
    aliquota = 0.225
    deduçao = 636.13
elfi 4664.68 < base_de_calculo:
    aliquota = 0.275
    deduçao = 869.36

IRRF = base_de_calculo X aliquota - deduçao    
