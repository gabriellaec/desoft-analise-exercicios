...
def multa(tempo1,tempo2):
    ...
    while i > (-1):
    	...
    	if instante > tempocarro and instante < tempocarro*1.2:
        	return ("O motorista de placa {0} vai ser multado em 130,16 reais.").format(placa)
    	elif instante > tempocarro and instante > tempocarro*1.2 and instante < tempocarro*1.5:
        	return ("O motorista de placa {0} vai ser multado em 195,23 reais.").format(placa)
    	elif instante > tempocarro and instante > tempocarro*1.5:
        	return ("O motorista de placa {0} vai ser multado em 3 vezes de 195,23 reais e suspenso de dirigir junto à apreensão do documento de habilitação.").format(placa)
    	else:
