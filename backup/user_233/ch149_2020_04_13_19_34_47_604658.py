...
def obter_aliquota_e_deducao(base_de_calculo):
...
def obter_irrf_simplificado(salario_bruto, contribuicao_inss, dependentes):
    ...
    aliquota, deducao = obter_aliquota_e_deducao(base_de_calculo)
...
irrf_simplificado = obter_irrf_simplificado(salario_bruto, contribuição_inss, dependentes)
