salario_bruto = int(input('Qual o seu salário? '))
dependentes = int(input('Quantas pessoas dependem desse salário? '))

# Calcula o INSS
if salario_bruto <= 1045.0:
    inss = salario_bruto * 0.075
elif salario_bruto > 1045.0 and salario_bruto <= 2089.6:
