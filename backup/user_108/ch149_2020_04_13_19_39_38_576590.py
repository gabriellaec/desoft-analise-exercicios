...
def aliquota_pro_salario(salario):
    aliquota = 0
...
def deducao_pro_salario(salario):
    deducao = 0
    if 1903.98 < salario <= 2826.65:
        deducao = 142.8
    elif 2826.65 < salario <= 3751.05:
...
print(dependentes)
print(deducao_pro_salario(salario)
base = salario - contribuicao_inss(salario) - dependentes * 189.59
irrf = base * aliquota_pro_salario(salario) - deducao_pro_salario(salario)
print(irrf)