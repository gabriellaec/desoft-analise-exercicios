...
while dinheiro > 0:	
	...
	if n_ou_p == "n":
		...
		if n_ou_p == "n" and 1 <= num <= 36 and num == sorteado:
			dinheiro += 35*aposta
			print (dinheiro)
			print (sorteado)
		elif n_ou_p == "n" and 1 <= num <= 36 and num != sorteado:
			dinheiro -= aposta
			print (dinheiro)
			print (sorteado)
		else:
		...
		if n_ou_p == "p" and ((chute_ip == "p" and (sorteado%2==0)) or (chute_ip == "i" and not sorteado%2==0)):
			dinheiro += aposta
			print (dinheiro)
			print (sorteado)
		elif n_ou_p == "p" and ((chute_ip == "p" and not sorteado%2==0) or (chute_ip == "i" and sorteado%2==0)):
			dinheiro -= aposta
			print (dinheiro)
			print (sorteado)
		else:
