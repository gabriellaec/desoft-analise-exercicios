...
def IRRF:
    if base_de_calculo < 1903.98:
        aliquota == 0
        deducao == 0
    elif base_de_calculo > 1903.98 and < 2826.65:
        aliquota == 0.075
        deducao == 142.80
    elif base_de_calculo > 2826.65 and < 3751.05:
        aliquota == 0.15
        deducao == 354.80
    elif base_de_calculo > 3751.05 and < 4664.68:
        aliquota == 0.225
        deducao == 636.13
    else:
        aliquota == 0.275
