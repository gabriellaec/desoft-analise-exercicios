depósito_inicial = float(input("Qual é seu depósito inicial? Déposito Inicial: "))
...
while numero_do_mês <= 24:
    mês = (depósito_inicial + deposito_mensal*numero_do_mês) * (1 + taxa_de_juros) ** (numero_do_mês)
