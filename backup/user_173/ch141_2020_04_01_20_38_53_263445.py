...
while pergunta1 != soma:
    pergunta2 = input ('Você quer continuar apostando ou desiste? Responda "continuar" se quiser e "desistir" se não quiser.')
    if pergunta2 == 'desistir':
        ...
        pergunta3 = int(input('Tente outro número. Vai te custar mais 20 dinheiros.'))
            if pergunta3 == soma:
                ...
                pergunta4 = input ('Você quer continuar apostando ou desiste? Responda "continuar" se quiser e "desistir" se não quiser.')
