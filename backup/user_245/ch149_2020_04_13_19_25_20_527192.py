...
def base_calculo(salario,INSS,numdependentes):
    ...
    return calculo
if base_calculo(salario,INSS,numdependentes)<=1903.98:
    aliquota2 = 0.0
    deducao = 0
if 1903.99<=base_calculo(salario,INSS,numdependentes) and base_calculo(salario,INSS,numdependentes)<=2826.64:
    aliquota2 = 7.5
    deducao = 142.8
if 2826.66<=base_calculo(salario,INSS,numdependentes) and base_calculo(salario,INSS,numdependentes)<=3751.05:
    aliquota2 = 0.15
    deducao = 354.80
elif 3751.06<=base_calculo(salario,INSS,numdependentes) and base_calculo(salario,INSS,numdependentes)<=4664.68:
    aliquota2 = 0.225
    deducao = 636.13
else:
    aliquota2 = 0.275
