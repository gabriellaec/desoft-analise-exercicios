        ...
        if continuar_jogando=="desistir":
            ...
            if sequencia == soma_dados:
                ...
                if continuar_tentando=="desistir":
                    aposta=="sim"
                elif continuar_tentando=="continuar":
                    sequencia2 = int(input("digite na sequência um número para tentar acertar e isso lhe custa mais 10 dinheiros")
                    if soma_dados == "sequencia2":
                        dinheiro-=10
